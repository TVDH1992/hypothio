...
export function Stap7Berekenen() {
  const { situatie, inkomen1, inkomen2, verplichtingen, woning, setResultaat, volgende } = useWizard();

  useEffect(() => {
    const timer = setTimeout(() => {
      const resultaat = berekenResultaat(situatie, inkomen1, inkomen2, verplichtingen, woning);
