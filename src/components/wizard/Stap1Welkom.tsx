...
export function Stap1Welkom() {
  ...
  return (
    <div className="text-center space-y-8">
      <div>
        <div className="w-20 h-20 bg-[#8B35C0]/10 rounded-full flex items-center justify-center mx-auto mb-5">
          <Home className="w-10 h-10 text-[#8B35C0]" />
        </div>
      ...
      <div className="space-y-3 text-left">
        ...
        <div className="grid grid-cols-2 gap-3">
          {([
            ...
            >
              <Icon className={`w-8 h-8 ${rol === val ? 'text-[#8B35C0]' : 'text-gray-300'}`} />
